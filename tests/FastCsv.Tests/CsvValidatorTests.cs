...
public class CsvValidatorTests
{
    ...
    public void TestLineEndings_Success(bool isValid, string csvContent, int actualDataRows, int actualFieldCount)
    {
    ...
    [InlineData(true, "\"First,Last,Names\",AGE,DOB\r\n\"Doe,John\",23,1/1/2000\r\n\"Sue,Mary\",34,1/1/2000", 2, 3)]
    public void TestSeparatorsInQuotedFields_Success(bool isValid, string csvContent, int actualDataRows, int actualFieldCount)
    {
        CsvValidator validator = new CsvValidator();
        var options = new ValidationOptions()
        {
